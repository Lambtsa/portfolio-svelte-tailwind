<script lang="ts">
  ...
  import ubiquiti from '$assets/images/ui.svg';
</script>
  ...
  <div class="max-w-screen-lg mx-auto grid grid-cols-1§ md:grid-cols-2 gap-4">
    <div class="flex justify-center items-start gap-4 py-8">
      <img
        ...
        alt="" />
      <div class="space-y-1">
        <h3 class="text-2xl text-white font-bold">Full-stack Javascript Engineer</h3>
        <p class="text-subtitle text-opacity-40">Aug 2021 - Present</p>
        <p class="text-subtitle">I am currently working as a full stack javascript engineer in the small team
